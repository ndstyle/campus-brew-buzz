...
export const useEnhancedUserProfile = (userId?: string) => {
  ...
  const fetchProfile = async (targetUserId?: string) => {
    ...
    try {
      ...
      console.log('👤 [ENHANCED PROFILE] Fetching profile for user:', profileUserId);
      ...
      if (userError) {
        console.error('❌ [ENHANCED PROFILE] Error fetching user data:', userError);
        throw userError;
      }
      ...
      if (reviewsError) {
        console.error('❌ [ENHANCED PROFILE] Error fetching reviews:', reviewsError);
      }
      ...
      console.log('👤 [ENHANCED PROFILE] Enhanced profile data loaded:', profileData);
